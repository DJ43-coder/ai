...
# Enter Employee Name: Atharv Punekar
# Enter Role/Department: Software Development

# Rate the following on a scale of 1 (Poor) to 5 (Excellent):
# Teamwork (1: Poor, 5: Excellent): 5
# Punctuality (1: Poor, 5: Excellent): 4
# Task Completion (1: Poor, 5: Excellent): 5
# Communication Skills (1: Poor, 5: Excellent): 4
# Problem Solving (1: Poor, 5: Excellent): 5
# Leadership (if applicable, else rate as 3) (1: Poor, 5: Excellent): 4

# === Performance Report ===
# Employee Name: Tejas Deshmukh
# Department/Role: Software Development
# Average Score: 4.50/5
# Performance Remark: Outstanding
# Recommendation: Keep up the great work. Consider for leadership roles or promotions.
