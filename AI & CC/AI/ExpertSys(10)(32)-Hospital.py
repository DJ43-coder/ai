...
# === Hospital Expert System: Patient Triage Assistant ===
# Enter Patient Name: Atharv Punekar
# Enter Age: 21

# Select Symptoms (Y/N):
# Chest Pain? (Y/N): n
# Shortness of Breath? (Y/N): n
# Heavy Bleeding? (Y/N): n
# High Fever? (Y/N): y
# Recent Injury? (Y/N): n
# Dizziness or Fainting? (Y/N): n
# Severe Stomach Pain? (Y/N): n
